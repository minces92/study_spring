...
public class RequestParamController {
     ...
     */
    @RequestMapping("/request-param-vi")
     ...
     * @RequestParam(name="xx")에서 파라미터 부분 생략 가능
     */
    @ResponseBody
...
//    //원래라면
//    @ResponseBody
//    @RequestMapping("/model-attribute-v1-manual")
//    public String modelAttributeManual(@RequestParam("username") String username, (@RequestParam("age") int age, Model model) {
//        // 1. 객체 생성 (기본 생성자 필요)
//        HelloData helloData = new HelloData();
//
//        // 2. Setter를 통한 데이터 바인딩 (이 부분이 핵심)
